...
1. **Pemetaan**: Kendarai robot melintasi ruang baru untuk membuat denah digital.
...
- **Operator Armada**: Akun pengguna standar yang ditetapkan ke satu atau lebih profil penyewaan. Anda dapat mengendarai robot yang ditetapkan, merekam peta, membuat rute, dan memeriksa status robot.
