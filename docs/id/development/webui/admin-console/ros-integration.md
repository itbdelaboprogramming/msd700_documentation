...
ujungnya. Dua hal di konsol ini memang menjangkau sampai ke robot atau ke armada kontainer yang
...
[Unit & Armada](/id/development/webui/admin-console/units-and-fleet); untuk jabat tangan nonce
...
::: info Relay armada adalah default; jalur legacy per-unit masih ada
...
- [Unit & Armada](/id/development/webui/admin-console/units-and-fleet): sub-tampilan Armada dan Tertunda yang menjadi dasar mekanisme ini.
...
- [Siklus Hidup Kontainer Unit](/id/development/unit-container-lifecycle): referensi lengkap untuk `unit_manager.js`, roster, dan relay armada.
