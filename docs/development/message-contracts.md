...
- [API Reference](/development/api-reference): REST API endpoints and data schemas.
- [State and Behavior](/development/state-and-behavior): Detailed state machines and failure transitions.
- [Architecture](/development/architecture): High-level system topology and trust boundaries.
