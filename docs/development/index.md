...
<LinkCards>
  <LinkCard icon="🏗️" title="Architecture" details="How the MSD700 Server and Unit fit together." link="/development/architecture" />
  ...
  <LinkCard icon="🔌" title="API Reference" details="Endpoints, requests, and responses." link="/development/api-reference" />
