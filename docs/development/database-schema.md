...
See [Data Sync](/development/data-sync) for how these two tables are actually used.

## Foreign keys, in full

![Foreign keys, in full](./diagrams/database-schema-foreign-keys-in-full.drawio)
...
wrong database. See [Docker Reference § Service and port map](/setup/docker-reference#service-and-port-map)
