...
# Unit Container Lifecycle Management

<RoleBadge role="developer" />

This document details the dynamic lifecycle management of per-unit relay containers (`rosweb_unit_<ULID>`) on the cloud server, managed automatically by `unit_manager.js` over the Docker socket.
