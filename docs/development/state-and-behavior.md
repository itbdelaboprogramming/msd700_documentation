...
- [Architecture](/development/architecture): Hardware and server topology overview.
- [API Reference](/development/api-reference): HTTP endpoints and error code references.
