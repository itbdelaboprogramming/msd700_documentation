...
[バックアップとリストア](/ja/development/backup-and-restore#_2軸バックアップアーキテクチャ)
...
回復できないのかについては
[ROS連携 § ユニットのエンロールメントとバインド解除](/ja/development/webui/admin-console/ros-integration#ユニットのエンロールメントとバインド解除)
を参照。
