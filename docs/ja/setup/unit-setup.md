...
[WiFi Hotspot + Client](/ja/setup/wifi-hotspot#provisioning-the-hotspot-once-per-unit) for the full
...
client. See [WiFi Hotspot + Client](/ja/setup/wifi-hotspot) for the full architecture and why a second
...
When the robot operates in locations without internet connectivity, connect your laptop or tablet directly to the robot's local network (or the [robot's WiFi hotspot](/ja/setup/wifi-hotspot), if Step 6 above was run):
...
- [WiFi Hotspot + Client](/ja/setup/wifi-hotspot): Full hotspot architecture, dongle hardware, and troubleshooting.
