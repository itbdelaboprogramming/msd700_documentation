...
- [Quick Start Guide](/getting-started/quick-start): Getting started in 5 minutes.
- [How the Robot Behaves](/getting-started/behavior): Safety watchdogs and session recovery.
- [Operator Troubleshooting](/getting-started/troubleshooting): Diagnosing common operator issues.
